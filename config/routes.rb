Rails.application.routes.draw do
  ...
  get "bookings/create" => "bookings#create_booking", as: :create_booking
  ...
  post "bookings" => "bookings#new_booking_details"
  get "bookings/new" => "bookings#new_booking_page", as: :new_booking
